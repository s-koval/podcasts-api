...
class CreatePodcastRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|min:4|unique:podcasts,name',
    ...
    public function messages()
    {
        return [
            ...
            'name.unique' => 'Podcast with this name is already presented in the system.',
    ...
    {
        throw new \Dingo\Api\Exception\StoreResourceFailedException('Could not create new podcast.', $validator->errors());
    }
}
